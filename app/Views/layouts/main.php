...
<head>
    ...
    <link rel="stylesheet" href="<?= $baseUrl ?>/assets/css/interface.css?v=20260820-2">
...
<?php if (($page ?? '') === 'deliveries'): ?><script src="<?= $baseUrl ?>/assets/js/deliveries.js?v=20260820-2"></script><?php endif; ?>
