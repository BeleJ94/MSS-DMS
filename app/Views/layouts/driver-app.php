...
<script>window.MSS_DRIVER_APP=<?= json_encode(['baseUrl' => $baseUrl, 'csrf' => Csrf::token(), 'activeMissionId' => (int) ($activeMissionId ?? 0), 'build' => '20260807-4'], JSON_UNESCAPED_SLASHES) ?>;</script>
<script src="<?= $baseUrl ?>/assets/js/driver-tracking.js?v=20260807-4"></script>
<script src="<?= $baseUrl ?>/assets/js/driver-app.js?v=20260807-4"></script>
<script src="<?= $baseUrl ?>/assets/js/driver-gps-diagnostics.js?v=20260807-4"></script>
